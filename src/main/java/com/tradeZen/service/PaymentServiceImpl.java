...
import com.tradeZen.repository.PaymentOrderRepository;
...
public class PaymentServiceImpl implements PaymentService {
	...
	public PaymentOrder createOrder(User user, Long amount, PaymentMethod paymentMethod) {
		...
		paymentOrder.setPaymetnMethod(paymentMethod);
	...
	public boolean proceedPaymentOrder(PaymentOrder paymentOrder, String paymentId) throws RazorpayException {
		...
		if(paymentOrder.getStatus().equals(PaymentOrderStatus.PENDING)) {
			if(paymentOrder.getPaymetnMethod().equals(PaymentMethod.RAZORPAY)) {
				...
				.addLineItem(SessionCreateParams.LineItem.builder()
						...
						.setPriceData(SessionCreateParams.LineItem.PriceData.builder()
								...
								.setProductData(SessionCreateParams.LineItem.PriceData
										.ProductData.builder().setName("Top up wallet").build()
								).build()
						).build()
				).build();
