...
public class CoinController {
	...
	@GetMapping
	public ResponseEntity<List<Coin>> getCoinList(@RequestParam( name = "page") int page) throws Exception{
	...
	@GetMapping("/top50")
	public ResponseEntity<JsonNode> getTop50CoinByMarketCapBank() throws Exception{
